describe('e2e UserRole Autority : ', function () {
    ...
    beforeAll(function() {
        ...
        element(by.model('userRole.name')).sendKeys('Full -roleMng');
        element(by.model('userRole.description')).sendKeys('this is a role test for Security userRole object');
        ...
        // create the new user
        element(by.model('user.username')).sendKeys('userRoleSecurity'); // unique & required
        ...
        element(by.model('user.role')).element(by.cssContainingText('option', 'Full -roleMng')).click();
        ...
        // Log new user
        logUser('userRoleSecurity', 'Test$4test');
    });
    ...
    it('Testing : creating', function() {
        ...
        expect(element(by.id('btnNewUserRole')).isPresent()).toBeFalsy();
    });
    ...
    it('Testing : updating & Deleting', function() {
        ...
        expect(browser.getCurrentUrl()).toMatch("#/admin/role"); // redirect occurs compare to other object
